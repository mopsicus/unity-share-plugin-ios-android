...
struct  ScrollbarVisibility_t184977789 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ScrollbarVisibility_t184977789, ___value___1)); }
