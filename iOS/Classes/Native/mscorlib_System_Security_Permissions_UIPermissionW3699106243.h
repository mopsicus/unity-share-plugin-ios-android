...
struct  UIPermissionWindow_t3699106243 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(UIPermissionWindow_t3699106243, ___value___1)); }
