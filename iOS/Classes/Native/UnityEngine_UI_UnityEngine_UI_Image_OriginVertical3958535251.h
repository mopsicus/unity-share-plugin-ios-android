...
struct  OriginVertical_t3958535251 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(OriginVertical_t3958535251, ___value___1)); }
