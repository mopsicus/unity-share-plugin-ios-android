...
struct  ClrTypeMetadata_t3077458456  : public TypeMetadata_t777805349
{
public:
...
public:
	inline static int32_t get_offset_of_InstanceType_2() { return static_cast<int32_t>(offsetof(ClrTypeMetadata_t3077458456, ___InstanceType_2)); }
