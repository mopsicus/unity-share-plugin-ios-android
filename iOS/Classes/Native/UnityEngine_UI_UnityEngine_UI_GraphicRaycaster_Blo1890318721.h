...
struct  BlockingObjects_t1890318721 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(BlockingObjects_t1890318721, ___value___1)); }
