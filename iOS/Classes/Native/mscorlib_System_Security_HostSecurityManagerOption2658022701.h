...
struct  HostSecurityManagerOptions_t2658022701 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(HostSecurityManagerOptions_t2658022701, ___value___1)); }
