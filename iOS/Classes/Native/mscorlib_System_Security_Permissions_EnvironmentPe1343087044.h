...
struct  EnvironmentPermissionAccess_t1343087044 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EnvironmentPermissionAccess_t1343087044, ___value___1)); }
