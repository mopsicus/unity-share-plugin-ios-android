...
struct  ReflectionPermissionFlag_t1843672246 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ReflectionPermissionFlag_t1843672246, ___value___1)); }
