...
{
public:
	ALIGN_TYPE (8) X509ChainStatus_t766901931  m_Items[1];
...
{
public:
	ALIGN_TYPE (8) Capture_t754001812 * m_Items[1];
...
{
public:
	ALIGN_TYPE (8) Group_t2151468941 * m_Items[1];
...
{
public:
	ALIGN_TYPE (8) Mark_t3811539797  m_Items[1];
...
{
public:
	ALIGN_TYPE (8) UriScheme_t1290668975  m_Items[1];
