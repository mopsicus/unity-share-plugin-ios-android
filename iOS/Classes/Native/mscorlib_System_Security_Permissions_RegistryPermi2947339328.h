...
struct  RegistryPermissionAccess_t2947339328 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(RegistryPermissionAccess_t2947339328, ___value___1)); }
