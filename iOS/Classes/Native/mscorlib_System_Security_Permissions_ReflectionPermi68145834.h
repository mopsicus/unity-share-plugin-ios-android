...
struct  ReflectionPermission_t68145834  : public CodeAccessPermission_t2127220
{
public:
...
public:
	inline static int32_t get_offset_of_flags_0() { return static_cast<int32_t>(offsetof(ReflectionPermission_t68145834, ___flags_0)); }
