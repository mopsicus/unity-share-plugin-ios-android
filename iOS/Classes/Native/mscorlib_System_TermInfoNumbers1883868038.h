...
struct  TermInfoNumbers_t1883868038 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(TermInfoNumbers_t1883868038, ___value___1)); }
